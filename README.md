...
- Rendering **LaTeX math formulas** via KaTeX
...
The visual supports **LaTeX math rendering** powered by [KaTeX](https://katex.org/). Both inline and block-level formulas work out of the box — no settings to change.
...
> 💡 **Tip:** Math formulas work inside regular Markdown paragraphs, tables, lists, and definition lists. They can also appear in measures generated by DAX string expressions.
