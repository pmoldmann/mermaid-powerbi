...
export function Editor({
    ...
    const docsButton = React.useMemo(() => {
        return {
            name: "docs",
            keyCommand: "docs",
            buttonProps: { "aria-label": "Documentation" },
            icon: (
    ...
    const donateButton = React.useMemo(() => {
        return {
            ...
            execute: (state, api) => {
                launchUrl("https://buy.stripe.com/00wbJ10AmdUIbQuewhgUM00");
            }
        };
    }, [onChange, value]);
                            ...
                            children: (<>
                                <div className="container" data-color-mode="light">
                                    <MDEditor
                                        ...
                                        commands={[saveButton, ...commands.getCommands(), docsButton, donateButton]}
